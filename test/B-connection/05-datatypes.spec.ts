...
describe('Data type encode/decode', function () {
    ...
    it('should parse "numeric" field (text)', async function () {
        await parseTest(DataTypeOIDs.numeric, ['321.2345', '-1232.567'], [321.2345, -1232.567],
            {columnFormat: DataFormat.text});
    });
    ...
    it('should parse "numeric" array field (text)', async function () {
        ...
        await parseTest(DataTypeOIDs._numeric, input, input,
            {columnFormat: DataFormat.text});
    });
    ...
    it('should encode "numeric" param', async function () {
        await encodeTest(DataTypeOIDs.numeric, [-1.2345, 1232.567]);
    });
    ...
    it('should encode "numeric" array param', async function () {
        ...
        await encodeTest(DataTypeOIDs._numeric, input, output);
    });
    ...
    it('should parse "uuid" field (text)', async function () {
        ...
        await parseTest(DataTypeOIDs.uuid, input, input,
            {columnFormat: DataFormat.text});
    });
    ...
    it('should parse "uuid" array field (text)', async function () {
        const input = [
            ...
            '2f3e45ba-3a13-4726-8a1b-3e3e3bb04836',
            '9d0c1257-7dbf-44a2-98ca-282083e0294c'];
        await parseTest(DataTypeOIDs._uuid, input, input,
            {columnFormat: DataFormat.text});
    });
    ...
    it('should encode "uuid" param', async function () {
        const input = [
            ...
            '2f3e45ba-3a13-4726-8a1b-3e3e3bb04836',
            '9d0c1257-7dbf-44a2-98ca-282083e0294c'];
        await encodeTest(DataTypeOIDs.uuid, input, input);
    });
    ...
    it('should encode "uuid" array param', async function () {
        const input = [
            ...
            '2f3e45ba-3a13-4726-8a1b-3e3e3bb04836',
            '9d0c1257-7dbf-44a2-98ca-282083e0294c'];
        await encodeTest(DataTypeOIDs._uuid, input, input);
    });
